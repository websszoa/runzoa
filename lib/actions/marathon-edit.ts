...
import type { Marathon, MarathonEditFormValues } from "@/lib/types";
...
export async function marathonEditAction(
  values: MarathonEditFormValues
  ...
  if (updateError) {
    ...
    return {
      success: false,
      message: updateError.message ?? "마라톤 수정에 실패했습니다.",
    };
  }
